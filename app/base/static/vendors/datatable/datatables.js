 ...
 *   https://datatables.net/download/#bs5/jq-3.7.0/dt-2.1.4/b-3.1.1/rr-1.5.0/sp-2.3.2/sl-2.0.5
 *
 * Included libraries:
 *   jQuery 3 3.7.0, DataTables 2.1.4, Buttons 3.1.1, RowReorder 1.5.0, SearchPanes 2.3.2, Select 2.0.5
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/jq-3.7.0/dt-2.1.4/b-3.1.1/rr-1.5.0/sp-2.3.2/sl-2.0.5",
